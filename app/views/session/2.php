    ...
    <header>
        <section class="container">
            ...
            <form action="" class="search-form">
                ...
                <button class="button search-button" type="submit"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 612.08 612.08"  xml:space="preserve"><g><path  d="M237.927,0C106.555,0,0.035,106.52,0.035,237.893c0,131.373,106.52,237.893,237.893,237.893c50.518,0,97.368-15.757,135.879-42.597l0.028-0.028l176.432,176.433c3.274,3.274,8.48,3.358,11.839,0l47.551-47.551c3.274-3.274,3.106-8.703-0.028-11.838L433.223,373.8c26.84-38.539,42.597-85.39,42.597-135.907C475.82,106.52,369.3,0,237.927,0zM237.927,419.811c-100.475,0-181.918-81.443-181.918-181.918S137.453,55.975,237.927,55.975s181.918,81.443,181.918,181.918S338.402,419.811,237.927,419.811z"/></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg></button>
            </form>
...
<section class="container s-list-container">
    <nav class='second-nav'>
        <?php $today = date('m.d') ?>
        <a class="sec-nav-a" href="/session/today">сегодня</a>
        <a class="sec-nav-a" href="/session/2">завтра</a>
        <a class="sec-nav-a" href="/session/3"><?= date("j F", strtotime("+2 days", strtotime($today)))?></a>
        <a class="sec-nav-a" href="/session/4"><?= date("j F", strtotime("+3 days", strtotime($today)))?></a>
        <a class="sec-nav-a" href="/session/5"><?= date("j F", strtotime("+4 days", strtotime($today)))?></a>
        <a class="sec-nav-a" href="/session/6"><?= date("j F", strtotime("+5 days", strtotime($today)))?></a>
        <a class="sec-nav-a" href="/session/7"><?= date("j F", strtotime("+6 days", strtotime($today)))?></a>
    </nav>
    </div>
    <div class="main-content">
        <div class="content-header">
            <h2>завтра</h2>
            <a href="/session/add">добавить сеанс</a>
        </div>
            ...
            <?php if(!empty($session)): ?>
                <div class="s-items">
                    <?php foreach($session as $item){ 
                        if($item['session_date'] == date('Y-m-d', strtotime('+1 days'))):
                        ?>
                        <a href="" class="n-item">
                            <div class="n-i-img"><img src="https://avatars.dzeninfra.ru/get-zen_doc/271828/pub_6568c3f024c97f15f649aca1_6568c50cf6adc66bb9be86e1/scale_1200" alt=""></div>
                            <div class="item-content">
                                ...
                                <button class="n-i-btn">купить билет</button>
                            </div>
