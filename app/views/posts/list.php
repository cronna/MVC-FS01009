...
<section class="container s-list-container">
    <nav class='second-nav' style="height: 190px;">
        ...
        <a class="sec-nav-a" href="/posts/posts">посты</a>
        <a class="sec-nav-a" href="/paper/papers">статьи</a>
        <a class="sec-nav-a" href="/channel/channels">каналы</a>
        <a class="sec-nav-a" href="/channel/my_channel">мои каналы</a>
    </nav>
    </div>
    <div class="main-content">
        <div class="content-header">
            <h2>лента</h2>
            <a href="/session/add">добавить новость</a>
        </div>
